...
export default function ContactPage() {
  return (
    <main id="main-content" className="contact-page">
      ...
      />
      <section
        className="contact-primary section-container"
      ...
      >
        <div className="contact-next-steps-inner section-container">
          ...
          <ol>
            ...
            <li>
              ...
              <p>
                Mia replies by email with any questions and the best next step
                for your room.
              </p>
            </li>
            <li>
